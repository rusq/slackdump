...
func (mr *MockRequestMockRecorder) HeaderValue(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockRequest) PostDataJSON(arg0 interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockRequestMockRecorder) PostDataJSON(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
