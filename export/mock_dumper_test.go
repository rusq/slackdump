...
func (m *Mockdumper) DumpRaw(ctx context.Context, link string, oldest, latest time.Time, processFn ...slackdump.ProcessFunc) (*types.Conversation, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, link, oldest, latest}
...
func (mr *MockdumperMockRecorder) DumpRaw(ctx, link, oldest, latest interface{}, processFn ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, link, oldest, latest}, processFn...)
...
func (mr *MockdumperMockRecorder) GetUsers(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockdumperMockRecorder) StreamChannels(ctx, chanTypes, cb interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
