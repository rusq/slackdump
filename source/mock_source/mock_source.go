...
// Source: github.com/rusq/slackdump/v4/source (interfaces: Sourcer,Resumer,Storage,SourceResumeCloser)
//
// Generated by this command:
//
//	mockgen -destination=mock_source/mock_source.go . Sourcer,Resumer,Storage,SourceResumeCloser
//
...
import (
	...
	source "github.com/rusq/slackdump/v4/source"
...
// MockSourceResumeCloser is a mock of SourceResumeCloser interface.
type MockSourceResumeCloser struct {
	ctrl     *gomock.Controller
	recorder *MockSourceResumeCloserMockRecorder
	isgomock struct{}
}

// MockSourceResumeCloserMockRecorder is the mock recorder for MockSourceResumeCloser.
type MockSourceResumeCloserMockRecorder struct {
	mock *MockSourceResumeCloser
}

// NewMockSourceResumeCloser creates a new mock instance.
func NewMockSourceResumeCloser(ctrl *gomock.Controller) *MockSourceResumeCloser {
	mock := &MockSourceResumeCloser{ctrl: ctrl}
	mock.recorder = &MockSourceResumeCloserMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSourceResumeCloser) EXPECT() *MockSourceResumeCloserMockRecorder {
	return m.recorder
}

// AllMessages mocks base method.
func (m *MockSourceResumeCloser) AllMessages(ctx context.Context, channelID string) (iter.Seq2[slack.Message, error], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AllMessages", ctx, channelID)
	ret0, _ := ret[0].(iter.Seq2[slack.Message, error])
	ret1, _ := ret[1].(error)
...
// AllMessages indicates an expected call of AllMessages.
func (mr *MockSourceResumeCloserMockRecorder) AllMessages(ctx, channelID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllMessages", reflect.TypeOf((*MockSourceResumeCloser)(nil).AllMessages), ctx, channelID)
}

// AllThreadMessages mocks base method.
func (m *MockSourceResumeCloser) AllThreadMessages(ctx context.Context, channelID, threadID string) (iter.Seq2[slack.Message, error], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AllThreadMessages", ctx, channelID, threadID)
	ret0, _ := ret[0].(iter.Seq2[slack.Message, error])
	ret1, _ := ret[1].(error)
...
// AllThreadMessages indicates an expected call of AllThreadMessages.
func (mr *MockSourceResumeCloserMockRecorder) AllThreadMessages(ctx, channelID, threadID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllThreadMessages", reflect.TypeOf((*MockSourceResumeCloser)(nil).AllThreadMessages), ctx, channelID, threadID)
}

// Avatars mocks base method.
func (m *MockSourceResumeCloser) Avatars() source.Storage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Avatars")
	ret0, _ := ret[0].(source.Storage)
	return ret0
...
// Avatars indicates an expected call of Avatars.
func (mr *MockSourceResumeCloserMockRecorder) Avatars() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Avatars", reflect.TypeOf((*MockSourceResumeCloser)(nil).Avatars))
}

// ChannelInfo mocks base method.
func (m *MockSourceResumeCloser) ChannelInfo(ctx context.Context, channelID string) (*slack.Channel, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChannelInfo", ctx, channelID)
	ret0, _ := ret[0].(*slack.Channel)
	ret1, _ := ret[1].(error)
...
// ChannelInfo indicates an expected call of ChannelInfo.
func (mr *MockSourceResumeCloserMockRecorder) ChannelInfo(ctx, channelID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChannelInfo", reflect.TypeOf((*MockSourceResumeCloser)(nil).ChannelInfo), ctx, channelID)
}

// Channels mocks base method.
func (m *MockSourceResumeCloser) Channels(ctx context.Context) ([]slack.Channel, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Channels", ctx)
	ret0, _ := ret[0].([]slack.Channel)
	ret1, _ := ret[1].(error)
...
// Channels indicates an expected call of Channels.
func (mr *MockSourceResumeCloserMockRecorder) Channels(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Channels", reflect.TypeOf((*MockSourceResumeCloser)(nil).Channels), ctx)
}

// Close mocks base method.
func (m *MockSourceResumeCloser) Close() error {
	m.ctrl.T.Helper()
...
func (mr *MockSourceResumeCloserMockRecorder) Close() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockSourceResumeCloser)(nil).Close))
}

// Files mocks base method.
func (m *MockSourceResumeCloser) Files() source.Storage {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Files")
	ret0, _ := ret[0].(source.Storage)
	return ret0
...
// Files indicates an expected call of Files.
func (mr *MockSourceResumeCloserMockRecorder) Files() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Files", reflect.TypeOf((*MockSourceResumeCloser)(nil).Files))
}

// Latest mocks base method.
func (m *MockSourceResumeCloser) Latest(ctx context.Context) (map[structures.SlackLink]time.Time, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Latest", ctx)
	ret0, _ := ret[0].(map[structures.SlackLink]time.Time)
	ret1, _ := ret[1].(error)
...
// Latest indicates an expected call of Latest.
func (mr *MockSourceResumeCloserMockRecorder) Latest(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Latest", reflect.TypeOf((*MockSourceResumeCloser)(nil).Latest), ctx)
}

// Name mocks base method.
func (m *MockSourceResumeCloser) Name() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Name")
	ret0, _ := ret[0].(string)
	return ret0
...
// Name indicates an expected call of Name.
func (mr *MockSourceResumeCloserMockRecorder) Name() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Name", reflect.TypeOf((*MockSourceResumeCloser)(nil).Name))
}

// Sorted mocks base method.
func (m *MockSourceResumeCloser) Sorted(ctx context.Context, channelID string, desc bool, cb func(time.Time, *slack.Message) error) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Sorted", ctx, channelID, desc, cb)
	ret0, _ := ret[0].(error)
	return ret0
...
// Sorted indicates an expected call of Sorted.
func (mr *MockSourceResumeCloserMockRecorder) Sorted(ctx, channelID, desc, cb any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Sorted", reflect.TypeOf((*MockSourceResumeCloser)(nil).Sorted), ctx, channelID, desc, cb)
}

// Type mocks base method.
func (m *MockSourceResumeCloser) Type() source.Flags {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Type")
	ret0, _ := ret[0].(source.Flags)
	return ret0
...
// Type indicates an expected call of Type.
func (mr *MockSourceResumeCloserMockRecorder) Type() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Type", reflect.TypeOf((*MockSourceResumeCloser)(nil).Type))
}

// Users mocks base method.
func (m *MockSourceResumeCloser) Users(ctx context.Context) ([]slack.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Users", ctx)
	ret0, _ := ret[0].([]slack.User)
	ret1, _ := ret[1].(error)
...
// Users indicates an expected call of Users.
func (mr *MockSourceResumeCloserMockRecorder) Users(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Users", reflect.TypeOf((*MockSourceResumeCloser)(nil).Users), ctx)
}

// WorkspaceInfo mocks base method.
func (m *MockSourceResumeCloser) WorkspaceInfo(ctx context.Context) (*slack.AuthTestResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WorkspaceInfo", ctx)
	ret0, _ := ret[0].(*slack.AuthTestResponse)
	ret1, _ := ret[1].(error)
...
// WorkspaceInfo indicates an expected call of WorkspaceInfo.
func (mr *MockSourceResumeCloserMockRecorder) WorkspaceInfo(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WorkspaceInfo", reflect.TypeOf((*MockSourceResumeCloser)(nil).WorkspaceInfo), ctx)
}
