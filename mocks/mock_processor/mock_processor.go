...
// Source: github.com/rusq/slackdump/v4/processor (interfaces: Conversations,CanvasMessenger,Users,Channels,ChannelInformer,Filer,WorkspaceInfo,MessageSearcher,FileSearcher,Searcher,Avatars)
//
// Generated by this command:
//
//	mockgen -destination ../mocks/mock_processor/mock_processor.go github.com/rusq/slackdump/v4/processor Conversations,CanvasMessenger,Users,Channels,ChannelInformer,Filer,WorkspaceInfo,MessageSearcher,FileSearcher,Searcher,Avatars
//
...
// MockCanvasMessenger is a mock of CanvasMessenger interface.
type MockCanvasMessenger struct {
	ctrl     *gomock.Controller
	recorder *MockCanvasMessengerMockRecorder
	isgomock struct{}
}

// MockCanvasMessengerMockRecorder is the mock recorder for MockCanvasMessenger.
type MockCanvasMessengerMockRecorder struct {
	mock *MockCanvasMessenger
}

// NewMockCanvasMessenger creates a new mock instance.
func NewMockCanvasMessenger(ctrl *gomock.Controller) *MockCanvasMessenger {
	mock := &MockCanvasMessenger{ctrl: ctrl}
	mock.recorder = &MockCanvasMessengerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCanvasMessenger) EXPECT() *MockCanvasMessengerMockRecorder {
	return m.recorder
}

// CanvasMessages mocks base method.
func (m *MockCanvasMessenger) CanvasMessages(ctx context.Context, channelID string, numThreads int, isLast bool, messages []slack.Message) error {
	m.ctrl.T.Helper()
...
func (mr *MockCanvasMessengerMockRecorder) CanvasMessages(ctx, channelID, numThreads, isLast, messages any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CanvasMessages", reflect.TypeOf((*MockCanvasMessenger)(nil).CanvasMessages), ctx, channelID, numThreads, isLast, messages)
}

// CanvasThreadMessages mocks base method.
func (m *MockCanvasMessenger) CanvasThreadMessages(ctx context.Context, channelID string, parent slack.Message, isLast bool, replies []slack.Message) error {
	m.ctrl.T.Helper()
...
func (mr *MockCanvasMessengerMockRecorder) CanvasThreadMessages(ctx, channelID, parent, isLast, replies any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CanvasThreadMessages", reflect.TypeOf((*MockCanvasMessenger)(nil).CanvasThreadMessages), ctx, channelID, parent, isLast, replies)
}
