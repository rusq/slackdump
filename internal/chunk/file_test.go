...
func TestFile_offsetTimestamps(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: offts{
				622:  offsetInfo{ID: TestChannelID, Timestamps: []int64{1234567890100000, 1234567890200000, 1234567890300000, 1234567890400000, 1234567890500000}},
				1452: offsetInfo{ID: TestChannelID, Timestamps: []int64{1234567890600000, 1234567890700000}},
				1815: offsetInfo{ID: TestChannelID, Timestamps: []int64{1234567890800000, 1234567890800000}},
				2266: offsetInfo{ID: "tC1234567890:1234567890.800000", Type: CThreadMessages, Timestamps: []int64{1234567890900000, 1234567891100000}},
				3720: offsetInfo{ID: TestChannelID2, Timestamps: []int64{1234567890100000, 1234567890200000, 1234567890300000, 1234567890400000, 1234567890500000}},
				4549: offsetInfo{ID: TestChannelID2, Timestamps: []int64{1234567890600000, 1234567890700000}},
				4911: offsetInfo{ID: TestChannelID2, Timestamps: []int64{1234567890800000, 1234567890800000}},
				5361: offsetInfo{ID: "tC987654321:1234567890.800000", Type: CThreadMessages, Timestamps: []int64{1234567890900000, 1234567891100000}},
			},
		},
	}
	for _, tt := range tests {
