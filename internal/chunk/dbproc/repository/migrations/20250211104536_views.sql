...
CREATE INDEX IF NOT EXISTS MESSAGE_I1 ON MESSAGE (CHUNK_ID, CHANNEL_ID, IS_PARENT);
...
-- V_UNFINISHED_THREADS IS THE COUNT OF UNFINISHED THREADS FOR EACH CHANNEL.  SUCCESSFUL EXPORT
-- MUST HAVE REF_COUNT = 0 FOR ALL CHANNELS.
...
-- ORPHAN THREADS FINDS ALL THE THREADS WHICH HAVE A PARENT, BUT NOT A CHILD (THREAD_MESSAGES HAS NOT (YET)
-- FETCHED THE THREAD.  IN THE NORMAL CONDITIONS ON A COMPLETED DUMP, ALL COUNTS FOR A SESSION SHOULD BE 0.
...
-- V_EMPTY_THREADS SHOWS ALL EMPTY THREADS (THREADS THAT HAVE PARENT MESSAGE, BUT NO MESSAGES IN THEM).
