...
// fileVersions is a struct that contains information about a group of files
// having the same FileID and different versions.
type fileVersions struct {
	// ID is the unique identifier of the file group.
	ID FileID
	// V is the list of versions of the files in the group.
	V []int64
}
...
func walkVersion(fsys fs.FS, fn func(gid fileVersions, err error) error) error {
