...
// Source: github.com/rusq/slackdump/v3/internal/client (interfaces: SlackClienter,Slack)
//
// Generated by this command:
//
//	mockgen -destination mock_client/mock_client.go . SlackClienter,Slack
//
...
func (m *MockSlackClienter) Client() *slack.Client {
	m.ctrl.T.Helper()
